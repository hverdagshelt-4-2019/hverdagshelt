...
select category, responsible_commune as 'commune', count(*) as 'tickets_in_communes' from ticket group by category, responsible_commune order by commune; -- National stats
