...
export class Register extends Component {
  ...
  render() {
    return (
      <div className="mx-auto" style={{ width: '400px' }} align="center">
        ...
        <form>
          <div className="form-group">
            ...
            <input
              ...
              placeholder="Passord"
              onChange={evt => {
                this.password1 = evt.target.value;
              }}
            />
            <input
              className="form-control"
              ...
              onChange={evt => {
                this.password2 = evt.target.value;
              }}
            />
          </div>
        </form>
        ...
        <br />
        <label>Har du allerede en bruker?</label> <NavLink to="">Logg inn her!</NavLink>
      </div>
    );
  }
  ...
  register() {
    if (this.password1 == this.password2) {
      ...
      personService.postNewUser(this.email, this.password1).catch(error => console.log('Noe gikk galt.'));
    } else {
