        ...
        return (
            <div style={{ height: '100%', width: '100%', paddingBottom: '300px'}}>
                ...
                <div className = "leftSide bg-primary" style={{height: '75vh'}}>
                    ...
                    <br/>
                    <br/>
                    <h5 id="header" className="header">Velkommen til hverdagshelt, vår nettside for kommunikasjon mellom kommuner og privat personer.
                    Her kan du blant annet se, kommentere og registrere nye saker som du ønsker kommune burde se nærmere på.</h5>
                    <hr/>
