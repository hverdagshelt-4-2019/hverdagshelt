declare module 'axios' {
  ...
  declare class AxiosRequestInterceptor<T, R = T> {
    use(
      successHandler: ?(response: AxiosXHRConfig<T, R>) => Promise<AxiosXHRConfig<*, *>> | AxiosXHRConfig<*, *>,
  ...
  declare class Axios {
    ...
    static <T, R>(config: AxiosXHRConfig<T, R> | string, config?: AxiosXHRConfig<T, R>): Promise<any>;
    request<T, R>(config: AxiosXHRConfig<T, R>): Promise<any>;
    delete<T, R>(url: string, config?: AxiosXHRConfigBase<T, R>): Promise<any>;
    get<T, R>(url: string, config?: AxiosXHRConfigBase<T, R>): Promise<any>;
    head<T, R>(url: string, config?: AxiosXHRConfigBase<T, R>): Promise<any>;
    post<T, R>(url: string, data?: mixed, config?: AxiosXHRConfigBase<T, R>): Promise<any>;
    put<T, R>(url: string, data?: mixed, config?: AxiosXHRConfigBase<T, R>): Promise<any>;
    patch<T, R>(url: string, data?: mixed, config?: AxiosXHRConfigBase<T, R>): Promise<any>;
    interceptors: {
